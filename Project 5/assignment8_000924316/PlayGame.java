    ...
    public void start(Stage stage) {
        ...
        canvas.setOnMouseClicked(event -> {
            ...
            if(turn==1){
                ...
                if(board[x][y]==null){
                    board[x][y]=new CirclePiece(x,y,Color.BLUE);
                    turn=1;
        ...
        EventHandler<ActionEvent> removeBtnEvent = new EventHandler<ActionEvent>() {
            public void handle(ActionEvent e)
            {
                ...
                if(board[x][y]!=null){
                    if(turn==1){
                        if(board[x][y] instanceof SquarePiece){
                            board[x][y]=null;
                            turn=0;
                            turnlbl.setText("Player 1(Circle)");
                        }else{
                        ...
                        if(board[x][y] instanceof CirclePiece){
                            board[x][y]=null;
                            turn=1;
                            turnlbl.setText("Player 2(Square)");
                        }else{
    ...
    public static void checkWinnerSquare(){
        ...
        for (int i = 0; i < board.length; i++) {
            ...
            for (int j = 0; j < board.length; j++) {
                ...
                if (board[j][i] instanceof SquarePiece) {
                    inLine++;
        ...
        if(board[0][0]!=null && board[1][1]!=null  && board[2][2]!=null){
            if (board[0][0] instanceof SquarePiece) {
                new Alert(Alert.AlertType.WARNING, "Player 2(Square) is the winner").showAndWait();
                return;
            }
        }
        ...
        if(board[0][2]!=null && board[1][1]!=null  && board[2][0]!=null){
            if (board[0][2] instanceof SquarePiece) {
                new Alert(Alert.AlertType.WARNING, "Player 2(Square) is the winner").showAndWait();
                return;
            }
        }
    ...
    public static void checkWinnerCircle(){
        ...
        for (int i = 0; i < board.length; i++) {
            ...
            for (int j = 0; j < board[i].length; j++) {
                ...
                if (board[i][j] instanceof CirclePiece) {
                    inLine++;
        ...
        for (int i = 0; i < board.length; i++) {
            ...
            for (int j = 0; j < board.length; j++) {
                ...
                if (board[j][i] instanceof CirclePiece) {
                    inLine++;
        ...
        //diagonal check
        if(board[0][0]!=null && board[1][1]!=null  && board[2][2]!=null){
            if (board[0][0] instanceof CirclePiece) {
                new Alert(Alert.AlertType.WARNING, "Player 1(Circle) is the winner").showAndWait();
                return;
            }
        }
        ...
        //diagonal check
        if(board[0][2]!=null && board[1][1]!=null  && board[2][0]!=null){
            if (board[0][2] instanceof CirclePiece) {
                new Alert(Alert.AlertType.WARNING, "Player 1(Circle) is the winner").showAndWait();
                return;
            }
        }
